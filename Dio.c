...
#include "Dio.h"
#include "Dio_Regs.h"
#include "Port.h" //to check if port driver is initialized
...
void Dio_Init(const Dio_ConfigType * ConfigPtr)
{
	...
	if (NULL_PTR == ConfigPtr)
	{
          Det_ReportError(DIO_MODULE_ID, DIO_INSTANCE_ID,
                          DIO_INIT_SID, DIO_E_PARAM_CONFIG);
          error = TRUE;
	}
        
        /* Check if the port is initialized.
         * Error check not exist in AUTOSAR 4.0.3 DIO SWS Document.
         * Port initialization is required as a prequiste for DIO Driver.
         * [DIO102] The Dio module’s user shall only use the Dio functions after the Port Driver
         * has been initialized. Otherwise the Dio module will exhibit undefined behavior.
         **/
